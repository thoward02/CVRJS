...
app.get("/", function(request, response){
  ...
  response.end("<html>TEST | PLay on 127.0.0.1/CVR  C:</html>"); //I'll fix this with a main page later
});


//Host Play file
app.get("/CVR/", function(request, response){
...
app.listen(Port, Ip, function(){
  ...
  console.log("[-- Started on  127.0.0.1/CVR --]");
